...
summary: "A detailed write-up of the Silent Breach Lab Cyberdefenders, showcasing the techniques and tools used to solve the challenge."
publishedAt: "2025-07-03"
tag: "ctf - writeup - dfir - cyberdefenders" 
---
...
<img src="/images/blogs/silent-breach-cyberdefenders/mount-image.png" alt="Mounting the disk image with FTK Imager" />
...
<img src="/images/blogs/silent-breach-cyberdefenders/url.png" alt="URL from which the file was downloaded" />
...
<img src="/images/blogs/silent-breach-cyberdefenders/ips.png" alt="IPs from the email"/>
...
<img src="/images/blogs/silent-breach-cyberdefenders/strings-output.png" alt="PowerShell script in strings output" />
