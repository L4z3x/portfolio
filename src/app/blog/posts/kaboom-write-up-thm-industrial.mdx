---
title: "Kaboom Writeup : TryHackMe Industrial 2025"
summary: "A detailed write-up of the Kaboom CTF challenge (OT category) from TryHackMe's Industrial 2025 series, showcasing the techniques and tools used to solve the challenge."
publishedAt: "2025-07-01"
tag: "ctf - writeup - ot - tryhackme" 
---
...
<img src="/images/blogs/kaboom-write-up-thm-industrial/scan.png" alt="scan"/>
we found that port 8080,80 and 22 are open
now let's scan commen ports on Modbus protocol
<img src="/images/blogs/kaboom-write-up-thm-industrial/common-ports-scan.png" alt="common-ports-scan" />
...
result:<br/>
<img alt="read-registers-result" src="/images/blogs/kaboom-write-up-thm-industrial/read-registers-result.png" />
...
result:<br/>
<img alt="write-coils-result"src="/images/blogs/kaboom-write-up-thm-industrial/write-coils-result.png" />

booom you got the flag at `http://<IP>/` <br/>
<img alt="flag-part1" src="/images/blogs/kaboom-write-up-thm-industrial/flag-part1.png" />
flag: `THM{BOOM_BOOM_KABOOM}`<br/>
...
<img src="/images/blogs/kaboom-write-up-thm-industrial/launch-program.png" alt="launch-program"/>
...
<img src="/images/blogs/kaboom-write-up-thm-industrial/flag-part2.png" alt="flag-part2"/>
flag: `FLAG{cooling_bypass_exploded}`
